  ...
  const handleSaveChanges = () => {
    ...
    onClose();
      ...
      const handleAddTimeRange = () => {
        const newId = timeRanges.length + 1;
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 w-full">
                  <div className="flex items-center space-x-2">
                    <select
                      ...
                      className={`min-w-[100px] bg-gray-600 text-white rounded px-3 py-2 border border-gray-500 ${
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      {range.status === 'booking' ? 'Booked' : range.status === 'available' ? 'Available' : 'Unavailable'}
                    </button>
                    ...
                    {/* Show Details only if there's booking data */}
                    {range.booking && (
                      <button
