...
function About() {
  return (
    <>
        <Navbar/>
        <div className="min-h-screen bg-gray-900 text-gray-400 pt-16 pb-20">
          <div className="container mx-auto px-4 sm:px-6 md:px-[30px] max-w-7xl">
            {/* Hero Section */}
            <div className="text-center mb-16 md:mb-20">
                <h1 className="text-3xl md:text-4xl font-bold mb-4 text-white">About LaVisual</h1>
            ...
            <section className="relative mb-20 md:mb-40">
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                    <div className="w-full md:w-1/2 text-gray-400 mb-8 md:mb-0 px-2">
                    ...
                    <div className="w-full md:w-1/2 h-[300px] md:h-[450px] bg-gray-700 rounded-lg overflow-hidden">
            ...
            <section className="text-center mb-20 md:mb-40">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                <div className="bg-gray-800 p-5 pt-8 rounded-lg shadow-md transform transition-transform duration-300 hover:scale-105 hover:bg-gray-700 flex flex-col items-center h-full">
            ...
            <section className="text-center mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                <div className="bg-gray-800 rounded-lg shadow-md transform transition-transform duration-300 hover:scale-105 hover:bg-gray-700 h-full">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="lg:col-start-2 bg-gray-800 rounded-lg shadow-md transform transition-transform duration-300 hover:scale-105 hover:bg-gray-700 h-full">
                  <div className="w-full aspect-[295/255]">
            ...
            <section className="text-center mt-20 mb-10">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 px-4">
                <Link to={'/contact'} className="w-full sm:w-auto">
                  <button className="bg-[#9333EA] text-white w-full sm:w-[125px] h-[50px] rounded-[6px] hover:scale-105 hover:bg-purple-700 transition">
                    Contact Us
                  </button>
                </Link>
                <Link to={'/portfolio'} className="w-full sm:w-auto">
                  <button className="bg-transparent text-white w-full sm:w-[155px] h-[50px] rounded-[6px] hover:scale-105 border border-white hover:bg-gray-700 transition">
                    View Our Work
                  </button>
                </Link>
              </div>
